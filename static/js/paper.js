document.addEventListener("DOMContentLoaded", () => {
  ...
  async function loadData() {
    ...
    return { nodeData, linkData, citationData, degreeData, countData };
  }

  loadData().then(({ nodeData, linkData, citationData, degreeData, countData }) => {
    ////////////////////////////////////////////////////////////////////////
    //                            Top Left                                //
    ////////////////////////////////////////////////////////////////////////
    if (topLeftDiv) {
      ...
      yearSlider.addEventListener("input", function() {
        ...
        const filteredNodes = nodeData.filter(node => node.year <= selectedYear);
      ...
      function plotGraph(filteredNodes, filteredEdges) {
        ...
        nodeCircles
          ...
          .on("click", function(event, d) {
            ...
            plotDegreeDistribution(globalDegreeData, "Degree Distribution of Community " + d.community)
          })
    ...
    if (distanceDiv) {
      ...
      // Initial plot
      plotBarChartFromJson(citationData, "Average numer of citations");
